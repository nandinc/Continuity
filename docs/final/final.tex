		...
		\subsubsection{Frame}
				...
				\item[Metódusok]$\ $
					\begin{description}
						...
						\item[\texttt{public boolean requestArea(FrameItem item, Area area)}] \hfill \\ A metódust hívó elem kérést intéz a kerethez,  hogy el szeretné foglalni a megadott területet.  A keret felelőssége a terület ellenőrzése, és szabad  terület esetén az elem pozíciójának frissítése. Sikeres foglalás esetén igazzal tér vissza.
					\end{description}
			\end{description}
			...
			\begin{description}
				...
				\item[Metódusok]$\ $
					\begin{description}
						...
						\item[\texttt{+requestArea(item : FrameItem, area : Area) : boolean}] \hfill \\A metódust hívó elem kérést intéz a kerethez,  hogy el szeretné foglalni a megadott területet.  A keret felelőssége a terület ellenőrzése, és szabad  terület esetén az elem pozíciójának frissítése. Sikeres foglalás esetén igazzal tér vissza.
	...
	%GENERATOR:CLASS_DESCRIPTIONS
		...
		\subsubsection{FrameDrawer}
			\begin{description}
				...
				\item[Metódusok]$\ $
					\begin{description}
						\item[\texttt{+draw(a : Area, g : Graphics)}] \hfill \\Kirajzol egy keretet 
					\end{description}
			\end{description}
