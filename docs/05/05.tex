		...
		\subsubsection{Óra use case leírások}
		    ...
		    \begin{enumerate}[label=\textbf{\arabic*.}, start=1]
                ...
                \ucitem{Stickman mozgatása}
                    ...
                    A Stickman objektum a \texttt{tick} esemény hatására -- mely az idő múlását jelzi -- felfelé mozoghat, amennyiben éppen ugrik, ellenkező esetben lefelé mozog (álló helyzetben is esik, mintha hatna rá a gravitációs gyorsulás).}
