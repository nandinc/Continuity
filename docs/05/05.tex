	...
	\subsection{Architektúra}
		...
		\begin{enumerate}[label=\textbf{\arabic*.}, start=0]
			...
			\testitem{Kulcs felvétele}
				...
				\tcel{Játékos kulcsot tartalmazó mezőbe lép, kulcs felvétele. Üzenet terjedésének bemutatása.}
				\tuse{P6}
			...
			\testitem{Keret átrendezése}
				\tframe{2}
				\tobjekt{Map, 2 Frame}
				\tcel{A játékos keretet próbál mozgatni. Objektumok nem kommunikálnak, a Map magában intézi a mozgást.}
				\tuse{P8}
			\testitem{Nézetváltás}
				\tframe{1}
				\tobjekt{Game}
