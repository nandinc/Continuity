...
%GENERATOR:CLASS_DESCRIPTIONS
	...
	\subsection{Szekvencia diagramok}
		...
		\begin{center}
			\includepdf[scale=0.8]{resources/seq_1-0_newMap.pdf}
		\end{center}

		\begin{center}
			\includepdf[scale=0.8]{resources/seq_1-0_loadGame.pdf}
		\end{center}
	
		\begin{center}
			\includepdf[scale=0.8]{resources/seq_1-1_addFrameItemToMap.pdf}
		\end{center}
	
		\begin{center}
			\includepdf[scale=0.8]{resources/seq_2-0_stickmanMoves.pdf}
		\end{center}
	
		\begin{center}
			\includepdf[scale=0.8]{resources/seq_2-1_interframeMove.pdf}
		\end{center}
	
	    \begin{center}
			\includepdf[scale=0.8]{resources/seq_2-2_frameChecksCollision.pdf}
		\end{center}
	
		\begin{center}
			\includepdf[scale=0.8]{resources/seq_2-3_fallOut.pdf}
		\end{center}
		
		\begin{center}
			\includepdf[scale=0.8]{resources/seq_2-3_checkNeighbouringFrame.pdf}
		\end{center}
	
		\begin{center}
			\includepdf[scale=0.8]{resources/seq_2-4_stickmanFalls.pdf}
		\end{center}
	
		\begin{center}
			\includepdf[scale=0.8]{resources/seq_3-0_moveFrame.pdf}
		\end{center}
	
	\subsection{State-chartok}
	
		\begin{center}
			\includepdf[scale=0.8]{resources/state_1-0_key.pdf}
		\end{center}
	
		\begin{center}
			\includepdf[scale=0.8]{resources/state_2-0_viewport.pdf}
		\end{center}
